...
// Topik/Deskripsi  : ADT Sederhana/ADT Garis

#include <stdio.h>
#include <math.h>
#include "garis.h"
#define x1(L) Absis(PAwal(L))
#define x2(L) Absis(PAkhir(L))
#define y1(L) Ordinat(PAwal(L))
#define y2(L) Ordinat(PAkhir(L))
#define P1(L) PAwal(L)
#define P2(L) PAkhir(L)
...
{
  printf("((%.2f,%.2f),(%.2f,%.2f))", x1(L), y1(L), x2(L), y2(L));
}
